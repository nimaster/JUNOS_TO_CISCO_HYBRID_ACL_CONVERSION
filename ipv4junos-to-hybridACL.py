...
#CREATE FUNCTIONS TO REMOVE SPACES AND SEMICOLONS
...
#GET LINE NUMBERS OF JUNOS ACL TERMS

terms=[]

with open("aclv4-inbound-original",'r') as file:
...
#CREATE SEPERATE FILE FOR EACH JUNOS TERM
...
#GET THE LINE AT THE END OF THE SOURCE-ADDRESSES        
    with open("term%s" %file_num,'r') as file:
        for number, line in enumerate(file):
            if '}' in line:
                src_add_end = number
...
#PRINT THE OBJECT-GROUP NAME
    if src_add_num == 999999999:
        ...
        print("object-group network ipv4 src-net-"+term_name[1])
...
#PRINT THE OBJECT-GROUP NAME
    if dst_add_num == 999999999:
        ...
        print("object-group network ipv4 dst-net-"+term_name[1])
...
#CHECK IF THE TERM IS A PERMIT OR A DENY
    ...
    if proto == 999999999:
        if frag == 'fragments':
            print('ipv4 access-list ACLv4-INBOUND',action,"ipv4",src_add_obj,dst_add_obj,"fragments")
        else:
            print('ipv4 access-list ACLv4-INBOUND',action,"ipv4",src_add_obj,dst_add_obj)
    elif proto == 'icmp':
        pass
    elif (dst_port == 999999999 and src_port == 999999999):
        if tcp_est == 'established':
            print('ipv4 access-list ACLv4-INBOUND',action,proto,src_add_obj,dst_add_obj,"established")
        elif frag == 'fragments':
            print('ipv4 access-list ACLv4-INBOUND',action,proto,src_add_obj,dst_add_obj,"fragments")
        else:
            print('ipv4 access-list ACLv4-INBOUND',action,proto,src_add_obj,dst_add_obj)

    elif dst_port == 999999999:
        if tcp_est == 'established':
            print('ipv4 access-list ACLv4-INBOUND',action,proto,src_add_obj,src_port_obj,dst_add_obj,"established")
        elif frag == 'fragments':
            print('ipv4 access-list ACLv4-INBOUND',action,proto,src_add_obj,src_port_obj,dst_add_obj,"fragments")
        else:
            print('ipv4 access-list ACLv4-INBOUND',action,proto,src_add_obj,src_port_obj,dst_add_obj)
    elif src_port == 999999999: 
        if tcp_est == 'established':
            print('ipv4 access-list ACLv4-INBOUND',action,proto,src_add_obj,dst_add_obj,dst_port_obj,"established")
        elif frag == 'fragments':
            print('ipv4 access-list ACLv4-INBOUND',action,proto,src_add_obj,dst_add_obj,dst_port_obj,"fragments")
        else:
            print('ipv4 access-list ACLv4-INBOUND',action,proto,src_add_obj,dst_add_obj,dst_port_obj)
    else:
        if tcp_est == 'established':
            print('ipv4 access-list ACLv4-INBOUND',action,proto,src_add_obj,src_port_obj,dst_add_obj,dst_port_obj,"established")
        elif frag == 'fragments':
            print('ipv4 access-list ACLv4-INBOUND',action,proto,src_add_obj,src_port_obj,dst_add_obj,dst_port_obj,"fragments")
        else:
            print('ipv4 access-list ACLv4-INBOUND',action,proto,src_add_obj,src_port_obj,dst_add_obj,dst_port_obj)
